...
import com.hack.rohanagarwal94.airtelhack.activity.MainActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void sendNotification(String number, String key) {
        Intent intent = new Intent(this, ReceivedRequestActivity.class);
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                ...
                .setContentTitle("Loan Request from " + number)
                .setContentText("Post Key " + key)
                .setAutoCancel(true)
